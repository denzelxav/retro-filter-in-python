...
@overload
def smoothstep(value: float, low_bound: float | ndarray, upp_bound: float | ndarray) -> float: ...

@overload
def smoothstep(value: ndarray, low_bound: float | ndarray, upp_bound: float | ndarray) -> ndarray: ...

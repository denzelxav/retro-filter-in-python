...
class Ui_ImageSelector(object):
    def setupUi(self, ImageSelector):
        ...
        self.input_vignette.setGeometry(QRect(60, 160, 88, 22))
        ...
        self.input_scan_lines = QDoubleSpinBox(ImageSelector)
        self.input_scan_lines.setObjectName(u"input_scan_lines")
        self.input_scan_lines.setEnabled(False)
        self.input_scan_lines.setGeometry(QRect(140, 120, 88, 23))
        self.input_scan_lines.setMinimum(-10.000000000000000)
        self.input_scan_lines.setMaximum(99999.000000000000000)
